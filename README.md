...
- ### Data Science
    ...
    This interactive map show the number of incidents happended in a neighborhood of NYC and the popup
     ...
     Here is the link to see the [HTML map.](http://www.mdavari.com/Data-Science-Portfolio/DS1_Interactive_Map/Incidents_Responded_to_by_Fire_Companies_Interactive_Map.html) and the [source_file](https://github.com/MahdiDavari/Data-Science-Portfolio/blob/master/DS1_Interactive_Map/Incidents_Responded_to_by_Fire_Companies_Interactive_Map.html)
)
